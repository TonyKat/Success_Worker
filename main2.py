...
def sorted_workers(workers):
    try:
        data = input_data(r'^[012345]{1}$',
                          ...
                          '\n1. По количеству руководящих должностей, нажмите "1".'
                          '\n2. По количеству успешных сдач проектов в руководящей должности, нажмите "2".'
                          '\n3. По количеству успешных дней в руководящей должности, нажмите "3".'
                          '\n4. По количеству участий в проектах (без лидерских проектов), нажмите "4".'
